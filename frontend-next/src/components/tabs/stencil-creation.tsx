...
export const StencilCreationTab = (props: any) => {
  ...
  const [selectedTab, setSelectedTab] = useState<"Placement" | "Advanced">("Placement");
      ...
      {props.stencilImage && (
        <div>
          ...
          <div className="flex flex-col w-full">
            ...
            {/* Tab selector for Placement/Advanced */}
            <div className="flex flex-row justify-around align-center mb-[1rem] w-[90%] mx-auto bg-[rgba(0,0,0,0.3)] p-[3px] rounded-2xl outline outline-[rgba(138,122,61,0.3)] text-nowrap">
              <p
                className={`Text__small rounded-2xl py-[0.5rem] flex-1 text-center ${selectedTab === "Placement" ? "outline outline-[rgba(138,122,61,0.6)] bg-[rgba(138,122,61,0.3)]" : ""} cursor-pointer`}
                onClick={() => {
                  playSoftClick2();
                  setSelectedTab("Placement");
                }}
              >
                Placement
              </p>
              <p
                className={`Text__small rounded-2xl py-[0.5rem] flex-1 text-center ${selectedTab === "Advanced" ? "outline outline-[rgba(138,122,61,0.6)] bg-[rgba(138,122,61,0.3)]" : ""} cursor-pointer`}
                onClick={() => {
                  playSoftClick2();
            ...
            {/* Tab content */}
            <div className="px-[0.5rem] mx-[0.5rem]">
